...
template <typename T>
using VertexAttribute = Map1::VertexAttribute<T>;
...
{
        cgogn::io::import_polyline<Vec3>(map_, surface_mesh);

        vertex_position_ = map_.template get_attribute<Vec3, Map1::Vertex>("position");
