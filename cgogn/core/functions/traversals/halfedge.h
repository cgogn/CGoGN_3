...
std::vector<Graph::HalfEdge> CGOGN_CORE_EXPORT incident_halfedges(const Graph& g, Graph::Edge e);

std::vector<Graph::HalfEdge> CGOGN_CORE_EXPORT incident_halfedges(const Graph& g, Graph::Vertex v);
