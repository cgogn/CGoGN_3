 ...
 */
CGOGN_NORETURN CGOGN_CORE_EXPORT void assertion_failed(const std::string& expression, const std::string& message,
 ...
 * \param[in] line_number line where the assertion failed.
 */
CGOGN_NORETURN CGOGN_CORE_EXPORT void should_not_have_reached(const std::string& message, const std::string& file_name,
...
#define cgogn_assert_not_reached_false(msg)                                                                            \
	_internal_cgogn_assert_not_reached(msg);                                                                           \
	return false;
