...
template <typename CELL>
bool is_indexed(const IncidenceGraphBase& /*m*/)
{
	return true;
}
...
auto get_mark_attribute(const MESH& ig)
...
template <typename CELL>
void release_mark_attribute(const IncidenceGraphBase& ig, IncidenceGraphBase::MarkAttribute* attribute)
{
