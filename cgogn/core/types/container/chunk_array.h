...
public:
	...
	inline const_iterator end() const { return const_iterator(this, this->container_->nb_elements()); }
	...
	inline iterator end() { return iterator(this, this->container_->nb_elements()); }
};
