...
const char* ShaderCopyDepth::vertex_shader_source_ =
	...
	"void main(void)\n"
	"{\n"
	"	vec4 vertices[4] = vec4[4](vec4(-1.0, -1.0, 0.0, 1.0), vec4(1.0, -1.0, 0.0, 1.0), vec4(-1.0, 1.0, 0.0, 1.0), "
	"vec4(1.0, 1.0, 0.0, 1.0));\n"
	"	gl_Position = vertices[gl_VertexID];\n"
	"	tc = (gl_Position.xy + vec2(1,1))/2;\n"
	"}\n";

const char* ShaderCopyDepth::fragment_shader_source_ = "#version 330\n"
...
ShaderParamCopyDepth::ShaderParamCopyDepth(ShaderCopyDepth* sh) : ShaderParam(sh), texture_(nullptr)
{
}
