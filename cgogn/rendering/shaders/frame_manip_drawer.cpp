...
static const char* geometry_shader_source2 =
	R"(
#version 330
layout (lines) in;
...
{
	load3_bind(vertex_shader_source2, fragment_shader_source2, geometry_shader_source2);
...
static const char* vertex_shader_source3 =
	R"(
#version 330
...
{
	load2_bind(vertex_shader_source3, fragment_shader_source3);
