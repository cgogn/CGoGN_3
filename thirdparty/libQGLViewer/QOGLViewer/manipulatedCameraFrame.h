...
/*! \brief The ManipulatedCameraFrame class represents a ManipulatedFrame with Camera specific mouse bindings.
  \class ManipulatedCameraFrame manipulatedCameraFrame.h QOGLViewer/manipulatedCameraFrame.h
  ...
  according to the mouse motion. See flySpeed(), sceneUpVector() and the QOGLViewer::MOVE_FORWARD and
...
public:
	...
	Camera::setPivotPointFromPixel() and QOGLViewer::RAP_FROM_PIXEL and QOGLViewer::RAP_IS_CENTER
...
public:
	...
	/*! Returns whether or not the QOGLViewer::ZOOM action zooms on the pivot point.
...
public Q_SLOTS:
	...
	Default value is 0.0, but it is modified according to the QOGLViewer::sceneRadius() when the
...
public:
	...
	ManipulatedCameraFrame position when a QOGLViewer::MOVE_FORWARD or QOGLViewer::MOVE_BACKWARD
	QOGLViewer::MouseAction is proceeded.

	\attention When the ManipulatedCameraFrame is set as the Camera::frame(), this value is set
	according to the QOGLViewer::sceneRadius() by QOGLViewer::setSceneRadius(). */
	qreal flySpeed() const { return flySpeed_; }

	/*! Returns the up vector of the scene, expressed in the world coordinate system.

	In 'fly mode' (corresponding to the QOGLViewer::MOVE_FORWARD and QOGLViewer::MOVE_BACKWARD
	QOGLViewer::MouseAction bindings), horizontal displacements of the mouse rotate
