...
/*! \brief An interface class for Frame constraints.
  \class Constraint constraint.h QOGLViewer/constraint.h
...
/*!
   ...
   \class AxisPlaneConstraint constraint.h QOGLViewer/constraint.h
   ...
   but that would imply to know the QOGLViewer::camera(), so that we can compute the projected
   coordinates of the rotation center (as is done with the QOGLViewer::SCREEN_ROTATE binding).
   However, adding an extra pointer to the QOGLViewer::camera() in all the AxisPlaneConstraint
...
/*! \brief An AxisPlaneConstraint defined in the Frame local coordinate system.
  \class LocalConstraint constraint.h QOGLViewer/constraint.h
...
/*! \brief An AxisPlaneConstraint defined in the world coordinate system.
	\class WorldConstraint constraint.h QOGLViewer/constraint.h
...
/*! \brief An AxisPlaneConstraint defined in the camera coordinate system.
  \class CameraConstraint constraint.h QOGLViewer/constraint.h
